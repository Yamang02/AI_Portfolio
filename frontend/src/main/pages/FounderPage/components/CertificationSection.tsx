...
export const CertificationSection: React.FC = () => {
  ...
  const certificationBody = (() => {
    ...
    if (certifications.length === 0) {
      return (
        <Card variant="default" padding="lg" className={styles.card}>
          <p className={styles.emptyText}>?±Î°ù???êÍ≤©Ï¶ùÏù¥ ?ÜÏäµ?àÎã§.</p>
        </Card>
      );
    }
    return (
              ...
              <div className={styles.certificationHeader}>
                ...
                {certification.credentialUrl && (
                  <TextLink
                    ...
                    ariaLabel={`${certification.name} ?êÍ≤©Ï¶??ïÏù∏`}
                  >
                    <svg
