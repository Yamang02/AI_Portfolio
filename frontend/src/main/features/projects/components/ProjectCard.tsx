...
const ProjectCard: React.FC<ProjectCardProps> = ({
  ...
  return (
    ...
    >
      {/* 상단 이미지/아이콘 영역 */}
      <div className="h-48 w-full bg-gradient-to-br from-gray-50 to-gray-100 dark:from-slate-700 dark:to-slate-800 flex items-center justify-center relative overflow-hidden">
        {/* 배지들 */}
        ...
        <div className={`fallback-icon ${hasValidImage ? 'hidden' : ''} absolute inset-0 flex items-center justify-center bg-gradient-to-br from-gray-50 to-gray-100 dark:from-slate-700 dark:to-slate-800`}>
