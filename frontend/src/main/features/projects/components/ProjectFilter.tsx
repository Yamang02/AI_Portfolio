...
import { TechStackBadge } from '../../../components/common/TechStackBadge/TechStackBadge';
import { categorizeTechStack } from '../../../pages/ProjectDetail/utils/techStackCategorization';
          ...
          <div className="space-y-4">
            {[...Array(4)].map((_, index) => (
              <div key={index} className="space-y-2">
                <div className="h-4 bg-surface-elevated dark:bg-slate-700 rounded w-32 animate-pulse"></div>
