  ...
  return (
    <div
      ...
      className={`
        ...
        transition-all duration-200 hover:shadow-lg hover:scale-105 hover:shadow-green-200 dark:hover:shadow-green-900/50
        ${isHighlighted ? 'ring-2 ring-green-400 dark:ring-green-600 shadow-lg scale-105' : ''}
      `}
