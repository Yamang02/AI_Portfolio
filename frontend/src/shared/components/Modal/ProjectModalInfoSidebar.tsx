...
interface ProjectModalInfoSidebarProps {
  project: Project;
  className?: string;
}
...
// 기술 스택을 TechStackMetadata 형태로 변환 (정렬/필터 섹션과 동일한 로직)
const convertToTechStackMetadata = (tech: string) => {
  const lowerTech = tech.toLowerCase();
  
  // 카테고리 결정 (정렬/필터 섹션과 동일한 분류)
...
// 기술 스택을 카테고리별로 분류 (정렬/필터 섹션과 동일한 로직 사용)
...
const ProjectModalInfoSidebar: React.FC<ProjectModalInfoSidebarProps> = ({
  project,
  className = ''
}) => {
  return (
    <aside className={`w-80 bg-gray-50 border-l border-gray-200 flex flex-col h-full ${className}`}>
      {/* 스크롤 가능한 메인 컨텐츠 영역 */}
      <div className="flex-1 overflow-y-auto p-5">
        {/* 팀 기여도 섹션 */}
        {project.isTeam && (project.role || (project.myContributions && project.myContributions.length > 0)) && (
          <div className="mb-5">
            <h3 className="text-base font-semibold text-gray-900 mb-2">팀 프로젝트 기여도</h3>
        ...
        {project.technologies && project.technologies.length > 0 && (
          <div className="mb-5">
            <h3 className="text-base font-semibold text-gray-900 mb-2">기술 스택</h3>
            <div className="space-y-2">
        ...
        {project.screenshots && project.screenshots.length > 0 && (
          <div className="mb-5">
            <h3 className="text-base font-semibold text-gray-900 mb-2">추가 스크린샷</h3>
            <div className="space-y-2">
      ...
      {/* 하단 고정 외부 링크 섹션 */}
      <div className="flex-shrink-0 p-5 bg-gray-50">
...
export default ProjectModalInfoSidebar;
