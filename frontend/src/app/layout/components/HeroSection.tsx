  ...
  return (
    <section className="w-full py-16 bg-white">
      <div className="max-w-4xl mx-auto text-center">
        <h2 className="text-4xl md:text-5xl font-extrabold text-black mb-6">Here Comes New Challenger!!</h2>
        <div className="text-3xl md:text-4xl font-bold text-black mb-6">이정준</div>
