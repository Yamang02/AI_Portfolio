...
import { TechStackTetris } from '../../../shared/components/TechStackTetris';
  ...
  return (
    <section className="w-full py-16 bg-white relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        ...
        <div className="backdrop-blur-md rounded-2xl p-5 md:p-6 shadow-2xl shadow-black/10 mb-8 max-w-lg mx-auto relative overflow-hidden">
          {/* 그라데이션 배경 - 중앙은 불투명, 경계는 투명 */}
          <div className="absolute inset-0 bg-gradient-to-br from-white/30 via-white/20 to-white/5 rounded-2xl"></div>
          <div className="absolute inset-0 bg-gradient-to-tl from-white/25 via-transparent to-white/10 rounded-2xl"></div>
          {/* 테두리 그라데이션 */}
          ...
          <a href="https://github.com/Yamang02" target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center w-10 h-10 rounded border border-gray-300 bg-white text-black hover:bg-gray-100 transition-colors">
          ...
          <button 
            ...
            className="inline-flex items-center justify-center w-10 h-10 rounded border border-gray-300 bg-white text-black hover:bg-gray-100 transition-colors"
          >
