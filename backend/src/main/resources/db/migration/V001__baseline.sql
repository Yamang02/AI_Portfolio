...
CREATE FUNCTION public.update_article_series_updated_at() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
...
CREATE FUNCTION public.update_profile_introduction_updated_at() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
    NEW.updated_at = CURRENT_TIMESTAMP;
...
CREATE SEQUENCE public.article_series_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE public.article_tech_stack (
    id bigint NOT NULL,
...
CREATE SEQUENCE public.article_tech_stack_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE SEQUENCE public.education_projects_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE public.education_tech_stack (
    id bigint NOT NULL,
    education_id bigint NOT NULL,
...
CREATE SEQUENCE public.education_tech_stack_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE SEQUENCE public.experience_projects_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE public.experience_tech_stack (
    id bigint NOT NULL,
    experience_id bigint NOT NULL,
    tech_stack_id bigint NOT NULL,
    is_primary boolean DEFAULT false,
...
CREATE SEQUENCE public.experience_tech_stack_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE public.profile_introduction (
    id bigint NOT NULL,
    content text NOT NULL,
...
CREATE SEQUENCE public.profile_introduction_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE SEQUENCE public.project_tech_stack_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE public.project_technical_cards (
    id bigint NOT NULL,
...
CREATE SEQUENCE public.project_technical_cards_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE public.tech_stack_metadata (
    id bigint NOT NULL,
...
CREATE SEQUENCE public.tech_stack_metadata_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE INDEX idx_admin_users_auth_provider ON public.admin_users USING btree (auth_provider);
...
CREATE INDEX idx_article_series_series_id ON public.article_series USING btree (series_id);
...
CREATE INDEX idx_article_series_sort_order ON public.article_series USING btree (sort_order);
...
CREATE INDEX idx_article_tech_stack_article_id ON public.article_tech_stack USING btree (article_id);
...
CREATE INDEX idx_article_tech_stack_tech_name ON public.article_tech_stack USING btree (tech_name);
...
CREATE INDEX idx_articles_business_id ON public.articles USING btree (business_id);
...
CREATE INDEX idx_articles_featured_sort_order ON public.articles USING btree (featured_sort_order) WHERE (is_featured = true);
...
CREATE INDEX idx_articles_is_featured ON public.articles USING btree (is_featured) WHERE (is_featured = true);
...
CREATE INDEX idx_articles_series_id ON public.articles USING btree (series_id) WHERE (series_id IS NOT NULL);
...
CREATE INDEX idx_articles_view_count ON public.articles USING btree (view_count) WHERE ((status)::text = 'published'::text);
...
CREATE INDEX idx_certifications_business_id ON public.certifications USING btree (business_id);
...
CREATE INDEX idx_certifications_date ON public.certifications USING btree (date);
...
CREATE INDEX idx_certifications_sort_order ON public.certifications USING btree (sort_order);
...
CREATE INDEX idx_education_business_id ON public.education USING btree (business_id);
...
CREATE INDEX idx_education_projects_education_id ON public.education_projects USING btree (education_id);
...
CREATE INDEX idx_education_projects_project_id ON public.education_projects USING btree (project_id);
...
CREATE INDEX idx_education_start_date ON public.education USING btree (start_date);
...
CREATE INDEX idx_education_tech_stack_education_id ON public.education_tech_stack USING btree (education_id);
...
CREATE INDEX idx_education_tech_stack_is_primary ON public.education_tech_stack USING btree (is_primary);
...
CREATE INDEX idx_education_tech_stack_tech_stack_id ON public.education_tech_stack USING btree (tech_stack_id);
...
CREATE INDEX idx_experience_projects_experience_id ON public.experience_projects USING btree (experience_id);
...
CREATE INDEX idx_experience_projects_project_id ON public.experience_projects USING btree (project_id);
...
CREATE INDEX idx_experience_tech_stack_experience_id ON public.experience_tech_stack USING btree (experience_id);
...
CREATE INDEX idx_experience_tech_stack_is_primary ON public.experience_tech_stack USING btree (is_primary);
...
CREATE INDEX idx_experience_tech_stack_tech_stack_id ON public.experience_tech_stack USING btree (tech_stack_id);
...
CREATE INDEX idx_experiences_business_id ON public.experiences USING btree (business_id);
...
CREATE INDEX idx_experiences_sort_order ON public.experiences USING btree (sort_order);
...
CREATE INDEX idx_experiences_start_date ON public.experiences USING btree (start_date);
...
CREATE INDEX idx_project_screenshots_display_order ON public.project_screenshots USING btree (display_order);
...
CREATE INDEX idx_project_screenshots_project_id ON public.project_screenshots USING btree (project_id);
...
CREATE INDEX idx_project_tech_stack_is_primary ON public.project_tech_stack USING btree (is_primary);
...
CREATE INDEX idx_project_tech_stack_project_id ON public.project_tech_stack USING btree (project_id);
...
CREATE INDEX idx_project_tech_stack_tech_stack_id ON public.project_tech_stack USING btree (tech_stack_id);
...
CREATE INDEX idx_tech_stack_metadata_category ON public.tech_stack_metadata USING btree (category);
...
CREATE INDEX idx_tech_stack_metadata_is_active ON public.tech_stack_metadata USING btree (is_active);
...
CREATE INDEX idx_tech_stack_metadata_is_core ON public.tech_stack_metadata USING btree (is_core);
...
CREATE INDEX idx_tech_stack_metadata_name ON public.tech_stack_metadata USING btree (name);
...
CREATE INDEX idx_tech_stack_metadata_sort_order ON public.tech_stack_metadata USING btree (sort_order);
...
CREATE INDEX idx_technical_cards_category ON public.project_technical_cards USING btree (category);
...
CREATE INDEX idx_technical_cards_pinned ON public.project_technical_cards USING btree (is_pinned);
...
CREATE INDEX idx_technical_cards_project ON public.project_technical_cards USING btree (project_id);
...
CREATE TRIGGER article_series_updated_at BEFORE UPDATE ON public.article_series FOR EACH ROW EXECUTE FUNCTION public.update_article_series_updated_at();
...
CREATE TRIGGER articles_set_published_at BEFORE INSERT OR UPDATE ON public.articles FOR EACH ROW EXECUTE FUNCTION public.set_article_published_at();
...
CREATE TRIGGER profile_introduction_updated_at BEFORE UPDATE ON public.profile_introduction FOR EACH ROW EXECUTE FUNCTION public.update_profile_introduction_updated_at();
...
CREATE TRIGGER update_education_projects_updated_at BEFORE UPDATE ON public.education_projects FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();
...
CREATE TRIGGER update_education_tech_stack_updated_at BEFORE UPDATE ON public.education_tech_stack FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();
...
CREATE TRIGGER update_experience_projects_updated_at BEFORE UPDATE ON public.experience_projects FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();
...
CREATE TRIGGER update_experience_tech_stack_updated_at BEFORE UPDATE ON public.experience_tech_stack FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();
...
CREATE TRIGGER update_project_screenshots_updated_at BEFORE UPDATE ON public.project_screenshots FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();
...
CREATE TRIGGER update_project_tech_stack_updated_at BEFORE UPDATE ON public.project_tech_stack FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();
...
CREATE TRIGGER update_tech_stack_metadata_updated_at BEFORE UPDATE ON public.tech_stack_metadata FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();
