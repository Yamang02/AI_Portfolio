...
public class AdminProjectController {
    ...
    public ResponseEntity<ApiResponse<List<ProjectResponse>>> getProjects(
        ...
        List<ProjectResponse> projects = adminProjectService.getProjects(filter);
    ...
    public ResponseEntity<ApiResponse<ProjectResponse>> getProject(@PathVariable Long id) {
        ...
        try {
            ProjectResponse project = adminProjectService.getProjectById(id);
    ...
    public ResponseEntity<ApiResponse<ProjectResponse>> createProject(
        ...
        try {
            ProjectResponse project = adminProjectService.createProject(request);
    ...
    public ResponseEntity<ApiResponse<ProjectResponse>> updateProject(
        ...
        try {
            ProjectResponse project = adminProjectService.updateProject(id, request);
