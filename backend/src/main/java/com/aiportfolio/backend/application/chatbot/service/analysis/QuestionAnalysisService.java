package com.aiportfolio.backend.application.chatbot.service.analysis;
...
/**
 * 규칙 기반 질문 분석 서비스
 * 헥사고날 아키텍처의 Application Service - QuestionAnalysisPort 구현체
 */
@Slf4j
@Service
public class QuestionAnalysisService implements QuestionAnalysisPort {
