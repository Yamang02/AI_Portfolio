...
public class ManageProjectService implements ManageProjectUseCase {
    ...
    public ProjectResponse createProjectWithRelations(
        ...
        if (techStackNames != null && !techStackNames.isEmpty()) {
            List<TechStackRelation> techStacks = toTechStackRelations(techStackNames);
        ...
        return projectResponseMapper.toResponse(created);
    }
    ...
    public ProjectResponse updateProjectWithRelations(
        ...
        return projectResponseMapper.toResponse(updated);
    }
     ...
     * 
     * @param techStackNames 기술 스택 이름 목록
     * @return TechStackRelation 리스트
     * @throws IllegalArgumentException 기술 스택을 찾을 수 없는 경우
     */
    public List<TechStackRelation> toTechStackRelations(List<String> techStackNames) {
        if (techStackNames == null || techStackNames.isEmpty()) {
