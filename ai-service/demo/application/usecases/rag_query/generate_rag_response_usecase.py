"""
Generate RAG Response Use Case
RAG 응답 생성 유스케이스
"""
...
from domain.entities.rag_response import RAGResponse, RAGResponseId
...
class GenerateRAGResponseUseCase:
    ...
    def __init__(self):
        ...
        logger.info("✅ Generate RAG Response Use Case initialized")
