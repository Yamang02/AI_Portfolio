"""
Search Similar Chunks Use Case
유사 청크 검색 유스케이스
"""
...
from domain.entities.query import Query, QueryId
from domain.entities.chunk import Chunk
from domain.entities.embedding import Embedding
from domain.entities.search_result import SearchResult, SearchResultId
...
class SearchSimilarChunksUseCase:
    ...
    def __init__(self, vector_store: VectorStore, embedding_model: EmbeddingModelPort):
        ...
        try:
            ...
            logger.info("✅ Search Similar Chunks Use Case initialized with embedding model and ConfigManager")
