"""
UseCase Factory - Demo Application Layer
UseCase 팩토리
...
class UseCaseFactory:
    ...
    def get_usecase(self, usecase_name: str):
    ...
    def _create_usecase(self, usecase_name: str):
        """UseCase 동적 생성"""
        ...
        try:
            ...
            for param_name, service_name in mapping["dependencies"].items():
                # 서비스 이름으로 직접 조회
                dependencies[param_name] = self.infrastructure_factory.get_component(service_name)
