  ...
  return (
    <section className="w-full py-16 bg-white">
      <div className="max-w-4xl mx-auto text-center">
        <h2 className="text-4xl md:text-5xl font-extrabold text-black mb-6">{appConfig.app.developerTitle}</h2>
        <div className="text-3xl md:text-4xl font-bold text-black mb-6">{appConfig.app.developerName}</div>
        <p className="text-gray-500 max-w-2xl mx-auto mb-10">
          도전을 두려워하지 않는 개발자 이정준입니다.
        </p>
        <div className="flex justify-center gap-4 mt-4">
          <a href={`https://github.com/${appConfig.github.username}`} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center w-10 h-10 rounded border border-gray-300 bg-white text-black hover:bg-gray-100 transition-colors">
